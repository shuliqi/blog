...
switch ($type) {
		case 'web':
			$inset = "insert into web(type,title,author,description,pic,content,timer) values('$type','$title','$author','$description','$newName','$content','$time')";
			...
			break;
		case 'jishu':
			$inset = "insert into jishu(type,title,author,description,pic,content,timer) values('$type','$title','$author','$description','$newName','$content','$time')";
		    if (mysql_query($inset)) {
		    	echo "<script>alert('插入成功');window.location.href='index.php';</script>";
		    } else {
		    	echo mysql_error();
			...
			break;
		case 'anli':
			$inset = "insert into anli(type,title,author,description,pic,content,timer) values('$type','$title','$author','$description','$newName','$content','$time')";
		    if (mysql_query($inset)) {
		    	echo "<script>alert('插入成功');window.location.href='index.php';</script>";
		    } else {
		    	echo mysql_error();
